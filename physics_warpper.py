...
class PhysicsInfo():
    ...
    def get_body_orientation(self):
        return self.__viewer.get_physics_body_orientations()
...
class PhysicsHandler():
    ...
    def get_state(self):
        ...
        return {
            ...
            'position': viewer.get_physics_body_positions(),
            'orientation': viewer.get_physics_body_orientations(),
        }
        
    def set_state(self, state_dict):
        self.viewer.set_body_positions(state_dict['position'])
        self.viewer.set_body_orientations(state_dict['orientation'])
